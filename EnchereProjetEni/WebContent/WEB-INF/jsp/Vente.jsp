...
<body>
    ...
    <form action="" method="get" class="form-example">
       ...
        
            <label for="email">Description : </label> <input type="email"
    ...
    <input type="date" id="start" name="trip-start" value="2021-12-17"
    ...
    <form action="" method="get" class="form-example">
        <div class="form-example">
            <label for="name">Rue : </label> <input type="text" name="article"
                id="article" required>
        </div>
        <div class="form-example">
